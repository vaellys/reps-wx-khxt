...
<body>
	<reps:container>
		<reps:panel id="myform" dock="top" action="add.mvc" formId="xform"
			validForm="true">
					<div style="margin-bottom: 20px;margin-top: 10px;"><span style="margin-left: 30px; margin-right: 500px;font-size:20px;font-weight:700">${khxtAppraiseSheet.season }${khxtAppraiseSheet.name }</span> <span style="font-size:20px;font-weight:700;">考核人：${khrPersonName }</span></div>
